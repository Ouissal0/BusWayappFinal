...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Bus bus = new Bus("123ABC", 50,"Bus1");
        Bus bus1 = new Bus("123ABC1", 50,"Bus2");
...
//        Station stationArrivee1 = new Station("Station 7", lat7, lon7);
        ...
        Voyage voyage = new Voyage(1,bus,dateVoyage, conducteur);
        Voyage voyage1 = new Voyage(2,bus1, dateVoyage1, conducteur1);
